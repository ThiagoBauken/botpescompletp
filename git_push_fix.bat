...
echo.
echo Fazendo commit...
git commit -m "fix: Add action_sequences.py to Docker build - Corrige ModuleNotFoundError no container - Dockerfile copia todos os .py files - Import robusto com fallbacks"
