...
class FishingBotUI:
    ...
    def __init__(self, config_manager=None):
        """Inicializar UI com ConfigManager"""
    ...
    def create_config_tab(self):
        ...
        tk.Label(maintenance_frame, text="Timeout para manutenção (segundos):",
                fg='white', bg='#2a2a2a', font=('Arial', 10)).pack(side='left')
        ...
        tk.Label(chest_grid, text="Lado do Baú:",
        ...
        tk.Label(chest_grid, text="Tipo de Macro:",
        ...
        # Distância do Baú
        tk.Label(chest_grid, text="Distância Baú (px):",
        ...
        options_frame = tk.LabelFrame(scrollable_frame, text="🔧 Opções Adicionais",
                                     bg='#2a2a2a', fg='white', font=('Arial', 11, 'bold'))
        ...
        tk.Checkbutton(options_grid, text="Auto Reload", variable=self.auto_reload_var,
                      fg='white', bg='#2a2a2a', selectcolor='#404040',
                      font=('Arial', 10)).grid(row=0, column=0, sticky='w', pady=5)

        tk.Checkbutton(options_grid, text="🎯 Foco Automático (impede ALT+TAB)",
                      variable=self.auto_focus_var,
                      fg='white', bg='#2a2a2a', selectcolor='#404040',
                      font=('Arial', 10)).grid(row=0, column=1, sticky='w', pady=5, padx=(30,0))

        # ========== SEÇÃO: VARAS QUEBRADAS ==========
        broken_frame = tk.LabelFrame(scrollable_frame, text="🔧 Manejo de Varas Quebradas",
                                    bg='#2a2a2a', fg='white', font=('Arial', 11, 'bold'))
        ...
        tk.Radiobutton(broken_grid, text="🗑️ Descartar (remove para lixo)",
                      variable=self.broken_rod_action_var, value='discard',
                      fg='white', bg='#2a2a2a', selectcolor='#404040',
                      font=('Arial', 10)).grid(row=0, column=0, sticky='w', pady=5)

        tk.Radiobutton(broken_grid, text="📦 Guardar no baú (clique direito)",
                      variable=self.broken_rod_action_var, value='save',
                      fg='white', bg='#2a2a2a', selectcolor='#404040',
                      font=('Arial', 10)).grid(row=1, column=0, sticky='w', pady=5)
        
        # ========== PRIORIDADE DE ISCAS ==========
        bait_config_frame = tk.LabelFrame(scrollable_frame, text="🎣 Prioridade de Iscas",
                                         bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
        bait_config_frame.pack(fill='x', padx=20, pady=10)

        tk.Label(bait_config_frame, text="🔄 Configure a ordem de prioridade das iscas | ✅ Use checkbox para ativar/desativar:",
        ...
        tk.Label(bait_controls_frame, text="Usar:", bg='#2a2a2a', fg='white',
        ...
        bait_save_btn = tk.Button(bait_reset_frame, text="💾 Salvar Prioridades",
        ...
        tk.Button(button_frame, text="💾 Salvar Todas as Configurações",
    ...
    def create_feeding_tab(self):
        ...
        subtitle_label = tk.Label(feeding_frame,
                                text="Template Matching Automático - Igual ao v3",
                                font=('Arial', 10),
                                fg='#cccccc', bg='#1a1a1a')
        ...
        tk.Checkbutton(enable_frame, text="✅ Sistema de alimentação ativado",
        ...
        tk.Label(status_frame, text="🤖 MODO: Detecção Automática de Template Matching",
                fg='#00ff88', bg='#2a2a2a', font=('Arial', 10, 'bold')).pack(anchor='w')
        tk.Label(status_frame, text="✅ Sistema idêntico ao v3 - Detecta filé frito e botão 'eat' automaticamente",
        ...
        tk.Label(catches_frame, text="pescas capturadas",
                fg='white', bg='#2a2a2a', font=('Arial', 10)).pack(side='left')

        # Trigger por tempo
        time_frame = tk.Frame(config_frame, bg='#2a2a2a')
        time_frame.pack(fill='x', pady=2)
        tk.Label(time_frame, text="⏰ Ou alimentar a cada:",
                fg='white', bg='#2a2a2a', font=('Arial', 10)).pack(side='left')
        ...
        tk.Label(session_frame, text="🐟 Quantos peixes comer por sessão:",
        ...
        tk.Label(session_frame, text="peixes",
                fg='white', bg='#2a2a2a', font=('Arial', 10)).pack(side='left')
        ...
        tech_frame = tk.LabelFrame(scrollable_frame, text="🔧 Informações Técnicas",
                                  bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
        ...
        # ========== CONTROLES E TESTES ==========
        controls_frame = tk.LabelFrame(scrollable_frame, text="🎮 Controles e Testes",
                                      bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
    ...
    def create_confidence_tab(self):
        ...
        subtitle_label = tk.Label(confidence_frame,
                                text="Ajuste a precisão necessária para cada template ser detectado.\nMudanças são aplicadas ao vivo e salvas automaticamente!",
                                font=('Arial', 10),
                                fg='#cccccc',
                                bg='#1a1a1a')
        subtitle_label.pack(pady=5)
        ...
        for category, template_list in template_categories.items():
            ...
            tk.Label(grid_frame, text="Confiança (0.5 = Flexível → 0.9 = Preciso)", fg='white', bg='#2a2a2a', font=('Arial', 10, 'bold')).grid(row=0, column=2, padx=5, pady=5)
            tk.Label(grid_frame, text="Ajuste Fino", fg='white', bg='#2a2a2a', font=('Arial', 10, 'bold')).grid(row=0, column=3, padx=5, pady=5)
        ...
        tk.Label(quick_values_frame, text="🎯 Atalhos Rápidos:", fg='white', bg='#1a1a1a',
        ...
        tk.Button(main_buttons_frame, text="🔄 Aplicar Padrão", command=self.reset_template_confidence,
                 bg='#6f42c1', fg='white', font=('Arial', 10, 'bold'),
                 padx=15, pady=5).pack(side='left', padx=5)

        tk.Button(main_buttons_frame, text="🎯 Críticos: Precisão Alta", command=self.set_high_precision_critical,
        ...
        tk.Button(main_buttons_frame, text="⭐ Salvar como Padrão", command=self.save_current_as_default,
                 bg='#fd7e14', fg='white', font=('Arial', 10, 'bold'),
                 padx=15, pady=5).pack(side='left', padx=5)

        tk.Button(main_buttons_frame, text="📁 Abrir Pasta Templates", command=self.open_templates_folder,
                 bg='#17a2b8', fg='white', font=('Arial', 10, 'bold'),
    ...
    def create_anti_detection_tab(self):
        ...
        # ========== ATIVAÇÃO GERAL ==========
        main_frame = tk.LabelFrame(scrollable_frame, text="⚡ Ativação Geral",
                                   bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
        main_frame.pack(fill='x', padx=20, pady=10)

        self.anti_detection_enabled = tk.BooleanVar(value=True)
        tk.Checkbutton(main_frame, text="Ativar Sistema Anti-Detecção",
        ...
        tk.Label(click_frame, text="Delay mínimo (ms):", bg='#2a2a2a', fg='white').pack()
        ...
        tk.Label(click_frame, text="Delay máximo (ms):", bg='#2a2a2a', fg='white').pack()
        ...
        movement_frame = tk.LabelFrame(scrollable_frame, text="⌨️ Variação de Movimentos A/D",
                                       bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
        movement_frame.pack(fill='x', padx=20, pady=10)

        self.movement_variation_enabled = tk.BooleanVar(value=True)
        tk.Checkbutton(movement_frame, text="Ativar variação de movimentos",
                      variable=self.movement_variation_enabled,
                      bg='#2a2a2a', fg='white', selectcolor='#2a2a2a',
                      command=self.update_anti_detection_settings).pack(pady=5)

        # Configurações do movimento A
        tk.Label(movement_frame, text="Duração A - Mín (s):", bg='#2a2a2a', fg='white').pack()
        ...
        tk.Label(movement_frame, text="Duração A - Máx (s):", bg='#2a2a2a', fg='white').pack()
        ...
        tk.Label(movement_frame, text="Duração D - Mín (s):", bg='#2a2a2a', fg='white').pack()
        ...
        tk.Label(movement_frame, text="Duração D - Máx (s):", bg='#2a2a2a', fg='white').pack()
        ...
        # ========== CICLO DE TECLA S ==========
        s_key_frame = tk.LabelFrame(scrollable_frame, text="🔄 Ciclo de Tecla S (Complementar aos Cliques)",
                                    bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
        s_key_frame.pack(fill='x', padx=20, pady=10)

        self.s_key_cycle_enabled = tk.BooleanVar(value=True)
        tk.Checkbutton(s_key_frame, text="Ativar ciclo automático de tecla S",
                      variable=self.s_key_cycle_enabled,
                      bg='#2a2a2a', fg='white', selectcolor='#2a2a2a',
                      command=self.update_anti_detection_settings).pack(pady=5)

        # Tempo pressionado
        tk.Label(s_key_frame, text="Tempo pressionado - Mínimo (s):", bg='#2a2a2a', fg='white').pack()
        ...
        tk.Label(s_key_frame, text="Tempo pressionado - Máximo (s):", bg='#2a2a2a', fg='white').pack()
        ...
        # Tempo solto
        tk.Label(s_key_frame, text="Tempo solto - Mínimo (s):", bg='#2a2a2a', fg='white').pack()
        ...
        tk.Label(s_key_frame, text="Tempo solto - Máximo (s):", bg='#2a2a2a', fg='white').pack()
        ...
        info_label = tk.Label(s_key_frame,
                             text="ℹ️ O ciclo de S inicia automaticamente junto com os cliques contínuos\n"
        ...
        # ========== PAUSAS NATURAIS ==========
        breaks_frame = tk.LabelFrame(scrollable_frame, text="☕ Pausas Naturais",
                                     bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
        ...
        # Duração da pausa
        tk.Label(breaks_frame, text="Duração mínima da pausa (minutos):", bg='#2a2a2a', fg='white').pack()
        ...
        tk.Label(breaks_frame, text="Duração máxima da pausa (minutos):", bg='#2a2a2a', fg='white').pack()
    ...
    def create_catch_viewer_tab(self):
        ...
        # ========== CONTROLES ==========
        control_frame = tk.LabelFrame(scrollable_frame, text="🎮 Controles",
                                     bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
        ...
        open_catch_window_btn = tk.Button(button_frame, text="👁️ Abrir Janela CATCH",
        ...
        stop_catch_btn = tk.Button(button_frame, text="⏹️ Parar CATCH Viewer",
        ...
        # Botão para teste
        test_catch_btn = tk.Button(button_frame, text="🧪 Testar Detecção",
        ...
        advanced_frame = tk.LabelFrame(scrollable_frame, text="⚙️ Configurações Avançadas",
        ...
        tk.Checkbutton(autostart_frame, text="🚀 Iniciar automaticamente com o bot",
                      variable=self.auto_start_var,
                      bg='#2a2a2a', fg='white', selectcolor='#404040',
                      font=('Arial', 10), activebackground='#2a2a2a').pack(anchor='w')

        # FPS e Performance
        performance_subframe = tk.LabelFrame(advanced_frame, text="⚡ Performance",
        ...
        tk.Label(fps_frame, text="🎯 FPS do Visualizador:",
        ...
        tk.Label(threshold_frame, text="🔍 Threshold NMS (pixels):",
                fg='white', bg='#333333', font=('Arial', 10)).pack(side='left')
        ...
        tk.Button(apply_frame, text="💾 Aplicar Configurações",
        ...
        # ========== ÁREA DE CAPTURA ==========
        capture_frame = tk.LabelFrame(advanced_frame, text="📺 Área de Captura",
                                     bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
        ...
        tk.Label(resolution_frame, text="📐 Resolução:",
                fg='white', bg='#2a2a2a', font=('Arial', 10)).pack(side='left')
        ...
        detect_btn = tk.Button(capture_frame, text="🔍 Detectar Janela Rust",
        ...
        # ========== INFORMAÇÕES ==========
        info_frame = tk.LabelFrame(scrollable_frame, text="ℹ️ Informações",
                                  bg='#2a2a2a', fg='white', font=('Arial', 10, 'bold'))
...
👁️ Use 'Abrir Janela CATCH' para visualizar as detecções."""
    ...
    def create_arduino_tab(self):
        ...
        # ========== STATUS DE CONEXÃO ==========
        status_frame = tk.LabelFrame(scrollable_frame, text="📡 Status da Conexão",
                                    bg='#2a2a2a', fg='white', font=('Arial', 11, 'bold'))
        status_frame.pack(fill='x', padx=20, pady=10)
        ...
        com_frame = tk.LabelFrame(scrollable_frame, text="🔌 Configuração da Porta COM",
                                 bg='#2a2a2a', fg='white', font=('Arial', 11, 'bold'))
        ...
        # Porta COM
        tk.Label(com_grid, text="Porta COM:",
                fg='white', bg='#2a2a2a', font=('Arial', 10)).grid(row=0, column=0, sticky='w', pady=5)
        ...
        tk.Button(com_grid, text="🔄 Atualizar", command=self.refresh_arduino_ports,
                 bg='#007acc', fg='white', font=('Arial', 9)).grid(row=0, column=2, padx=5, pady=5)
        
        # Baud Rate
        tk.Label(com_grid, text="Baud Rate:",
                fg='white', bg='#2a2a2a', font=('Arial', 10)).grid(row=1, column=0, sticky='w', pady=5)
        ...
        # Timeout
        tk.Label(com_grid, text="Timeout (s):",
        ...
        controls_frame = tk.LabelFrame(scrollable_frame, text="🎮 Controles de Conexão",
                                      bg='#2a2a2a', fg='white', font=('Arial', 11, 'bold'))
        controls_frame.pack(fill='x', padx=20, pady=10)
        ...
        tk.Button(buttons_frame, text="🔍 Testar Conexão", command=self.test_arduino_connection,
                 bg='#ffc107', fg='black', font=('Arial', 10, 'bold'),
                 padx=15, pady=5).pack(side='left', padx=5)
        ...
        tk.Button(buttons_frame, text="❌ Desconectar", command=self.disconnect_arduino,
                 bg='#dc3545', fg='white', font=('Arial', 10, 'bold'),
                 padx=15, pady=5).pack(side='left', padx=5)
        
        # ========== TESTE DE COMANDOS ==========
        test_frame = tk.LabelFrame(scrollable_frame, text="🧪 Teste de Comandos",
                                  bg='#2a2a2a', fg='white', font=('Arial', 11, 'bold'))
        test_frame.pack(fill='x', padx=20, pady=10)
        ...
        tk.Button(test_grid, text="🖱️ Teste Click Esquerdo", command=lambda: self.send_arduino_command("MOUSECLICK:L"),
                 bg='#17a2b8', fg='white', font=('Arial', 9), width=18).grid(row=0, column=0, padx=5, pady=5)

        tk.Button(test_grid, text="🖱️ Teste Click Direito", command=lambda: self.send_arduino_command("MOUSECLICK:R"),
                 bg='#17a2b8', fg='white', font=('Arial', 9), width=18).grid(row=0, column=1, padx=5, pady=5)

        tk.Button(test_grid, text="⌨️ Teste Tecla E", command=lambda: self.send_arduino_command("KEYPRESS:e"),
                 bg='#6f42c1', fg='white', font=('Arial', 9), width=18).grid(row=1, column=0, padx=5, pady=5)

        tk.Button(test_grid, text="🎣 Teste Tecla A", command=lambda: self.send_arduino_command("KEYPRESS:a"),
                 bg='#fd7e14', fg='white', font=('Arial', 9), width=18).grid(row=1, column=1, padx=5, pady=5)
        
        # ========== LOG DE COMUNICAÇÃO ==========
        log_frame = tk.LabelFrame(scrollable_frame, text="📋 Log de Comunicação",
                                 bg='#2a2a2a', fg='white', font=('Arial', 11, 'bold'))
        ...
        tk.Button(log_frame, text="🗑️ Limpar Log", command=self.clear_arduino_log,
                 bg='#6c757d', fg='white', font=('Arial', 9),
                 padx=10, pady=3).pack(pady=5)
        
        # ========== INFORMAÇÕES ==========
        info_frame = tk.LabelFrame(scrollable_frame, text="ℹ️ Informações do Arduino",
                                  bg='#2a2a2a', fg='white', font=('Arial', 11, 'bold'))
        info_frame.pack(fill='x', padx=20, pady=10)
...
📋 Verifique a porta COM no Gerenciador de Dispositivos do Windows"""
                ...
                if hasattr(self.config_manager, 'save_config'):
                    ...
                    if hasattr(self, 'hotkey_status_label'):
                        self.hotkey_status_label.config(
                            text="✅ Hotkeys salvas e aplicadas!",
                            fg='#28a745'
                        )
    ...
    def open_catch_viewer_window(self):
        ...
        try:
            if self.catch_viewer_window is None or not self.catch_viewer_window.winfo_exists():
                ...
                tk.Label(status_header, text="📊 STATUS GERAL",
                ...
                tk.Label(canvas_frame, text="🎮 CAPTURA AO VIVO",
                ...
                tk.Label(stats_frame, text="📈 ESTATÍSTICAS DETALHADAS",
                ...
                template_frame = tk.LabelFrame(stats_frame, text="🎯 Templates Ativos",
                                              fg='#ffaa00', bg='#2a2a2a', font=('Arial', 10, 'bold'))
                ...
                # Atualizar status
                self.catch_viewer_status_label.config(text="📊 Status: Janela Aberta", fg='#28a745')
    ...
    def test_catch_detection(self):
        ...
        try:
            ...
            self.catch_viewer_status_label.config(text="📊 Status: Testando...", fg='#ffc107')
            ...
            def test_detection():
                ...
                if hasattr(self, 'catch_stats_label'):
                    self.catch_stats_label.config(text="🎯 Detecções: 1 (teste)\n🔍 Templates ativos: 5\n⏱️ FPS: 5")
                
                if hasattr(self, 'catch_viewer_status_label'):
                    self.catch_viewer_status_label.config(text="📊 Status: Teste Concluído", fg='#28a745')
                                    ...
                                    if hasattr(self, 'viewer_fishing_stats'):
                                        try:
                                            if hasattr(self, 'fishing_engine') and self.fishing_engine:
                                                ...
                                                fishing_text = "Peixes: 0 | Ciclos: 0\nTempo: 00:00:00\n(Engine não disponível)"

                                            self.viewer_fishing_stats.config(text=fishing_text)
                                        except Exception as e:
                                            self.viewer_fishing_stats.config(text="Erro ao obter estatísticas")
                                    ...
                                    if hasattr(self, 'viewer_rod_status'):
                                        try:
                                            ...
                                            if inventory_open:
                                                ...
                                                rod_text = "🎣 STATUS DAS VARAS (Tempo Real)\n\n"
    ...
    def toggle_viewer_pause(self):
        ...
        try:
            ...
            if self.viewer_paused:
                self.viewer_pause_btn.config(text="▶️ Play", bg='#28a745')
                if hasattr(self, 'viewer_general_status'):
                    self.viewer_general_status.config(text="⏸️ VIEWER PAUSADO")
                ...
                if hasattr(self, 'viewer_general_status'):
                    self.viewer_general_status.config(text="▶️ VIEWER ATIVO")
    ...
    def apply_viewer_config(self):
        ...
        try:
            ...
            # Feedback visual
            if hasattr(self, 'catch_viewer_status_label'):
                self.catch_viewer_status_label.config(text="✅ Configurações aplicadas!", fg='#28a745')
                self.main_window.after(3000, lambda: self.catch_viewer_status_label.config(
                    text="📊 Status: Configurado", fg='#17a2b8'))
    ...
    def reset_viewer_config(self):
        ...
        try:
            ...
            # Feedback visual
            if hasattr(self, 'catch_viewer_status_label'):
                self.catch_viewer_status_label.config(text="🔄 Padrões restaurados!", fg='#ffc107')
    ...
    def create_status_bar(self):
        ...
        try:
            ...
            self.status_bar_label = tk.Label(status_frame, text="Status: Pronto", 
            ...
            # Separador visual  
            sep_label = tk.Label(right_frame, text=" | ", bg='#2d2d2d', fg='#666666')
            sep_label.pack(side=tk.RIGHT, padx=5)
            
            # Versão
            version_label = tk.Label(right_frame, text="v4.0", 
        ...
        try:
            ...
            if self.fishing_engine:
                if self.fishing_engine.start():
                    ...
                    self.status_label.config(text="❌ Erro ao iniciar", fg='red')
            else:
                # Modo simulação sem engines
                self.bot_running = True
                self.bot_paused = False
                self.status_label.config(text="🟡 Simulação", fg='orange')
    ...
    def stop_bot(self):
        ...
        try:
            if self.fishing_engine:
                ...
                self.bot_running = False
                self.bot_paused = False
                self.status_label.config(text="🔴 Parado (sim)", fg='red')
    ...
    def _test_arduino_thread(self):
        ...
        try:
            ...
            self.root.after(0, lambda: self.arduino_connection_status.config(text="Testando conexão..."))
            ...
            with serial.Serial(port, baud, timeout=timeout) as ser:
                ...
                if response == "PONG":
                    ...
                    self.root.after(0, lambda: self.arduino_connection_status.config(text="Teste OK"))
                    ...
                    self.root.after(0, lambda: self.arduino_connection_status.config(text="Firmware incorreto"))
            ...
            if "PermissionError" in error_msg or "Acesso negado" in error_msg:
                ...
                self.root.after(0, lambda: self.arduino_connection_status.config(text="Porta em uso"))
                self.root.after(0, lambda: self.arduino_status_indicator.config(fg="orange"))
                ...
                self.root.after(0, lambda: self.arduino_connection_status.config(text="Porta não encontrada"))
                ...
                self.root.after(0, lambda: self.arduino_connection_status.config(text="Erro no teste"))
                self.root.after(0, lambda: self.arduino_status_indicator.config(fg="red"))
    ...
    def _connect_arduino_thread(self):
        ...
        try:
            ...
            self.root.after(0, lambda: self.arduino_connection_status.config(text="Conectando..."))
            self.root.after(0, lambda: self.arduino_status_indicator.config(fg="yellow"))
            ...
            if response == "PONG":
                ...
                self.root.after(0, lambda: self.arduino_connection_status.config(text="Conectado e funcionando"))
                self.root.after(0, lambda: self.arduino_status_indicator.config(fg="green"))
                ...
                self.root.after(0, lambda: self.arduino_connection_status.config(text="Conectado - firmware incorreto?"))
                self.root.after(0, lambda: self.arduino_status_indicator.config(fg="orange"))
            ...
            self.root.after(0, lambda: self.arduino_connection_status.config(text="Erro na conexão"))
            self.root.after(0, lambda: self.arduino_status_indicator.config(fg="red"))
    ...
    def disconnect_arduino(self):
        ...
        try:
            ...
            self.arduino_connection_status.config(text="Desconectado")
